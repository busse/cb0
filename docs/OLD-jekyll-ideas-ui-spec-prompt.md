# OLD - UI Specification Prompt

> **Note**: This document is archived for reference. The current design system follows Bauhaus/Experimental Jetset/Swiss-German principles. See `.cursor/rules/ui-design.mdc` for the current specification.
